-- PROCEDURE: public.sp_purgeallusers()

-- DROP PROCEDURE IF EXISTS public.sp_purgeallusers();

CREATE OR REPLACE PROCEDURE public.sp_purgeallusers(
	)
LANGUAGE 'sql'
AS $BODY$
-- delete user data
...
$BODY$;
ALTER PROCEDURE public.sp_purgeallusers()
    OWNER TO heliaagent;
