    ...
    sync(player: Player) {
        ...
        for (const i of player.currentSystem.stars) {
            ...
            objects.push({
                ...
                listString: () => {
                    return `${fixedString('STAR', 9)}${fixedString(player.currentSystem.systemName, 24)} ${fixedString(od, 8)}`;
                }
            });
        }
        ...
        for (const i of player.currentSystem.planets) {
            ...
            objects.push({
                ...
                listString: () => {
                    return `${fixedString('PLANET', 9)}${fixedString(i.planetName, 24)} ${fixedString(od, 8)}`;
                }
            });
        }
        ...
        for (const i of player.currentSystem.stations) {
            ...
            const d: OverviewRow = {
                ...
                listString: () => {
                    return `${fixedString('STATION', 9)}${fixedString(i.stationName, 24)} ${fixedString(od, 8)}`;
                }
            };
        ...
        for (const i of player.currentSystem.ships) {
            ...
            const d: OverviewRow = {
                ...
                listString: () => {
                    return `${fixedString('SHIP', 9)}${fixedString(i.ownerName, 16)} ${fixedString(i.texture, 7)} ${fixedString(od, 8)}`;
                }
            };
        ...
        for (const i of player.currentSystem.jumpholes) {
            ...
            const d: OverviewRow = {
                ...
                listString: () => {
                    return `${fixedString('JUMPHOLE', 9)}${fixedString(i.jumpholeName, 24)} ${fixedString(od, 8)}`;
                }
            };
...
function overviewDistance(px: number, py: number, x: number, y: number): string {
